...
def prepare(
    source_path: Path = Path("../../../../corpora/external/openllama/"),
    tokenizer_path: Path = Path("../../../../corpora/external/corpus_2023/open_llama.model"),
    destination_path: Path = Path("data/openllama_sample"),
